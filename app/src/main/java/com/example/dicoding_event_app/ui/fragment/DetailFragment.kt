...
import com.example.dicoding_event_app.databinding.FragmentDetailBinding
import com.example.dicoding_event_app.helpers.DateHelper.format
import com.example.dicoding_event_app.ui.detail.DetailViewModel
        ...
        binding.apply {
            ...
            btnDetailEventOpenLink.setOnClickListener {
                ...
                if (eventDetail?.link == null) {
                    Toast.makeText(requireContext(), "Link tidak ditemukan", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
